...
> **Methodology superseded.** This document describes the original
> DHS-regression / structural-break keyword validation approach. As of
> 2026-07-17 (agreed with Jeremias), the pipeline uses a simpler G1/G2
> methodology instead — see the main [`README.md`](../../README.md) for
> the current approach and `code/mine/v7_scoring.py` for the
> implementation. Kept here for background on how the original keyword
> list was validated.
